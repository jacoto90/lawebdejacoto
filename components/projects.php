    ...
    <div class="container">
        ...
        <div class="cards three">
            <?php foreach ($profile['projects'] as $project): ?>
                <?php $projectUrl = str_replace('%lang%', $lang, $project['url']); ?>
                <article class="card project-card">
                    ...
                    <a href="<?= htmlspecialchars($projectUrl) ?>" target="_blank" rel="noopener noreferrer"><?= htmlspecialchars($t['projects_visit']) ?></a>
                </article>
            <?php endforeach; ?>
        </div>
    </div>
